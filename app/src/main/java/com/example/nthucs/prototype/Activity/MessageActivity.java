...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            intent_chat_bot.setClass(MessageActivity.this, ChatBotActivity.class);
            ...
            intent_temp_record.setClass(MessageActivity.this, MyTemperatureRecord.class);
            startActivity(intent_temp_record);
            finish();
        } else if (id == R.id.water_record){
            Intent intent_water_record = new Intent();
            intent_water_record.setClass(MessageActivity.this, DrinkWaterDiary.class);
